            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog-post">
                        ...
                        <img src="{{ url('foto/'.$artikel->foto) }}" alt="" width="700px">
                        ...
                        <a class="btn btn-outline-primary mb-4"
                            href="{{action('ArtikelController@show', $artikel->id)}}">Read
                            More</a>
                ...
                <div class="col-lg-4">
                    ...
                    {{-- Mengambi kategori yang telah disediakan  --}}
                    <div class="p-3">
                    ...
                    {{-- Mengambil judul pada latest post --}}
                    <div class="p-3">
                    ...
                    <nav class="blog-pagination">
                        <button class="btn btn-success mb-3"><a href="{{action('ArtikelController@create')}}"
                                style="text-decoration: none; color :white">Tambah
                                Data</a></button>
                        <a href="{{ url('artikels')}}"><button class="btn btn-success mb-3">Edit/Delete/More
                                Option</button></a>
                    </nav>
                </div>
