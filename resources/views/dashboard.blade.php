...
<head>
    ...
    <link href="dashboard/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
        media="all">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="dashboard/images/icon/logo-white.png" alt="Cool Admin" />
                </a>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="dashboard/images/icon/logo-white.png" alt="CoolAdmin" />
                                </a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="recent-report2">
                                    <h3 class="title-3 mb-4">Artikel</h3>
                                    <div class="chart-info">
                                        <div class="chart-info-right">
                                            <div class="rs-select2--dark rs-select2--md m-r-10">
                                                <button class="btn btn-success mb-3"><a
                                                        href="{{action('ArtikelController@create')}}"
                                                        style="text-decoration: none; color :white">Tambah
                                                        Data</a></button>
                                            </div>
                                            <div class="rs-select2--dark rs-select2--sm">
                                                <a href="{{ url('artikels')}}"><button
                                                        class="btn btn-success mb-3">Edit/Delete/More
                                                        Option</button></a>
                                                <div class="dropDownSelect2"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <h3 class="tittle-3 mb-4">Membership</h3>
                                    <div class="chart-info">
                                        <div class="chart-info-right">
                                            <div class="rs-select2--dark rs-select2--md m-r-10">
                                                <button class="btn btn-success mb-3"><a href="memberships"
                                                        style="text-decoration: none; color :white">Daftar
